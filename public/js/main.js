...
let inputRadiusR = document.querySelectorAll("input")[7];

inputRadiusR.addEventListener("click", ()=>{
    divCouleur.style.borderRadius = ` 0px ${inputRadiusR.value}px 0px 0px`
})
let inputRadiusB = document.querySelectorAll("input")[7];

inputRadiusB.addEventListener("click", ()=>{
    divCouleur.style.borderRadius = ` 0px 0px ${inputRadiusL.value}px 0px`
})
let inputRadiusB = document.querySelectorAll("input")[7];
